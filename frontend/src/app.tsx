...
import { Database, FlaskConical, House, Scale, ShieldCheck } from 'lucide-react'
...
const routeTree = rootRoute.addChildren([indexRoute, runsRoute, biasRoute])
